package com.analytics.sdk.common.runtime.broadcast;
...
public class LocalBroadcastManager {
    ...
    public static LocalBroadcastManager init(Context context) {
        synchronized (mLock) {
            if (mInstance == null) {
    ...
    public static void registerReceiver(BroadcastReceiver receiver, String filterAction) {
        IntentFilter intentFilter = new IntentFilter(filterAction);
        getInstance().registerReceiver(receiver,intentFilter);
    }
    ...
    public static void unregisterReceiver(BroadcastReceiver receiver) {
        getInstance().unregisterReceiver2(receiver);
    }
     ...
     */
    void unregisterReceiver2(BroadcastReceiver receiver) {
        synchronized (mReceivers) {
    ...
    public static boolean sendBroadcast(String action,String data){
        Intent intent = new Intent(action);
        intent.putExtra("data",data);
        return getInstance().sendBroadcast(intent);
    }
