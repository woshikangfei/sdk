    ...
    void processRequest(final Request<?> request) throws InterruptedException {
        ...
        try {
            ...
            if (entry == null) {
                ...
                // Cache miss; startReport off to the network dispatcher.
            ...
            // If it is completely expired, just startReport it to the network.
            if (entry.isExpired()) {
            ...
            if (!entry.refreshNeeded()) {
                ...
                // but we need to also startReport the request to the network for
                // refreshing.
