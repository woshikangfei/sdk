...
public class JiGuangRewardVideoHorizontalManger {
    ...
    private JiGuangHorizontalVideoView horizontalVideoView;
    ...
    public JiGuangRewardVideoHorizontalManger(Activity activity , boolean isPlayComplation, ResponseData responseData, RewardVideoAdListener adListener){
    ...
    private void initView() {
        horizontalVideoView=new JiGuangHorizontalVideoView(activity);
        frameVideoLayout=horizontalVideoView.getFrameVideoLayout();
        fullScreenVideoView=horizontalVideoView.getVideoView();
        ivBackground=horizontalVideoView.getIvBackground();
        tvSecond=horizontalVideoView.getTvSecond();
        webView=horizontalVideoView.getWebView();
        lastFrameLayout=horizontalVideoView.getLastFrameLayout();
