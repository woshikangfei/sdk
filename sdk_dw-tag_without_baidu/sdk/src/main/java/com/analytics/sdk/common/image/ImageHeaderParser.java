...
/**
 * 主要用来获取图片的类型,然后设置位数(8888还是565)
 * copy from glide 4.7.1 , 去掉了获取方向的代码
 *
 * @author devy
 *
...
public final class ImageHeaderParser {
    ...
    static ImageHeaderParser DEFAULT = new ImageHeaderParser();

    public static ImageHeaderParser getDefault(){
        return DEFAULT;
    }
