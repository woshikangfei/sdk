...
package com.analytics.sdk.common.image.pool;

import android.annotation.TargetApi;
import android.graphics.Bitmap;
import android.os.Build;

import com.analytics.sdk.common.image.ImageHelper;
...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    public void put(Bitmap bitmap) {
        int size = ImageHelper.getBitmapByteSize(bitmap);
    ...
    public Bitmap get(int width, int height, Bitmap.Config config) {
        int size = ImageHelper.getBitmapByteSize(width, height, config);
    ...
    public Bitmap removeLast() {
        ...
        if (removed != null) {
            int removedSize = ImageHelper.getBitmapByteSize(removed);
    ...
    public int getSize(Bitmap bitmap) {
        return ImageHelper.getBitmapByteSize(bitmap);
    }
        ...
        public boolean equals(Object o) {
            if (o instanceof Key) {
                ...
                return size == other.size
                        && ImageHelper.bothNullOrEqual(config, other.config);
            }
            return false;
        }
