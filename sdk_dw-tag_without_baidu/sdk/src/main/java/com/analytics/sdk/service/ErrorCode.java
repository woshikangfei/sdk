...
public interface ErrorCode {
    ...
    interface Api {
         ...
         * 容器已销毁
         */
        int ERROR_AD_CONTAINER_DESTORY = 50005;
        /**
         * 图片加载失败
         */
        int ERROR_AD_IMAGE = 50006;
    }
    ...
    interface RewardVideo {
         ...
         */
        int ERROR_VIDEO_SHOWN = 10 * 10000;
        /**
         * 成功加载广告后再进行广告展示
         */
        int ERROR_VIDEO_COMPLETED_SHOWN = 10 * 10001;
        /**
         * 视频加载失败
         */
        int ERROR_VIDEO_LOAD = 10 * 10002;
    ...
    interface FeedList {
         ...
         * GDT 数据为空
         */
        int ERROR_VIDEO_SHOWN = 11 * 10000;
    }
    ...
    interface Interstitial {
         ...
         * GDT 数据为空
         */
        int ERROR_HANDLE_EXCEPTION = 12 * 10000;
    }
    ...
    interface RequestParams {
         ...
         * GDT 数据为空
         */
        int ERROR_AD_CONTAINER_ISNULL = 13 * 10000;
    }
