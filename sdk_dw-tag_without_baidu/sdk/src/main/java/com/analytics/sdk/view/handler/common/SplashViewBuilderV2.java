...
import com.analytics.sdk.service.ad.IAdServiceHelper;
...
public class SplashViewBuilderV2 {

    static final String TAG = SplashViewBuilderV2.class.getSimpleName();
    ...
    public interface BuildListener {
        void onShow(SplashViewBuilderV2 builder);
        void onError();
        void onSkipClicked();
    }

    public static SplashViewBuilderV2 build(AdResponse adResponse, YdtAdBean ydtAdBean, BuildListener viewClick){
        SplashViewBuilderV2 builder = new SplashViewBuilderV2();
    ...
    private void initFullView() {
        ...
        StrategyRootLayout splashRootLayout = (StrategyRootLayout) activity.getLayoutInflater().inflate(R.layout.jhsdk_splash_with_api_fill_layout,adResponse.getClientRequest().getAdContainer());
    ...
    private void startBuildView() {
        ...
        if(adResponse.getResponseData().isSelfRenderFillType()){ //信息流填充
            ...
            adBitmap = IAdServiceHelper.getAdBitmap();
            adHeight = IAdServiceHelper.getAdHeight();
            adWidth = IAdServiceHelper.getAdWidth();
    ...
    private void show() {
        ...
        builderListener.onShow(SplashViewBuilderV2.this);
    }
