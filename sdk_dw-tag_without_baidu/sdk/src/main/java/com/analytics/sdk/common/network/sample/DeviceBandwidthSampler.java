...
public class DeviceBandwidthSampler {
    ...
    if (sPreviousBytes >= 0) {
      synchronized (this) {
        long curTimeReading = SystemClock.elapsedRealtime();
          ...
          Log.i("networkTrace","curTimeReading = " + curTimeReading + " , mLastTimeReading = " + mLastTimeReading + ",diff time = " + (curTimeReading - mLastTimeReading) + " , diff byte = " + byteDiff);
  ...
  private class SamplingHandler extends Handler {
       ...
       */
      static final long SAMPLE_TIME = 200;
