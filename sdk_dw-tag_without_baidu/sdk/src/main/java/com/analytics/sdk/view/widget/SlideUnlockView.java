...
import com.analytics.sdk.common.view.animator.AnimationListener;
import com.analytics.sdk.common.view.animator.ViewAnimator;
...
public class SlideUnlockView extends RelativeLayout {
    ...
    public SlideUnlockView(Context mContext) {
        super(mContext);
        this.mContext = mContext;
        initView();
    }

    public SlideUnlockView(Context mContext, AttributeSet attrs) {
        super(mContext, attrs);
        this.mContext = mContext;
        initView();
    }

    public SlideUnlockView(Context mContext, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        slideImageViewWidth= UIHelper.dip2px(getContext(), 50);
        slideImageViewResId= R.drawable.jhsdk_icon_slide;
        slideImageViewResIdAfter=R.drawable.jhsdk_icon_slide;
        viewBackgroundResId= R.drawable.jhsdk_shape_slide_button;
        textHint="滑动解除锁定";
        textSize=5;
        textColorResId=Color.parseColor("#606985");
        THRESHOLD=0.5f;
    }
    ...
    protected void initView() {
        ...
        LayoutInflater.from(mContext).inflate(R.layout.jhsdk_slide_to_unlock,
                this, true);
        ...
        tv_hint.setTextSize(UIHelper.dip2px(getContext(),textSize));
        tv_hint.setTextColor(textColorResId);
        tv_hint.setText(TextUtils.isEmpty(textHint)? "滑动解除锁定":textHint);
        ...
        rl_slide.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                DISTANCE_LIMIT= (int) (SlideUnlockView.this.getWidth()*THRESHOLD);//默认阈值是控件宽度的一半
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        logI(TAG, "MotionEvent.ACTION_UP,之前移动的偏移值：" + getTranslationY(v));
...
//                        }
    ...
    private void scrollToLeft(final View v) {
        ...
        logI(TAG, "scrollToLeft,ViewHelper.getTranslationX(v)：" + getTranslationX(v));
        ...
        ViewAnimator
                .animate( rl_slide)
                .translationX(getTranslationX(v), -params1.leftMargin)
                ...
                .onStop(new AnimationListener.Stop() {
                    ...
                    public void onStop() {
                        ...
                        logI(TAG, "scrollToLeft动画结束,ViewHelper.getTranslationX(v):" + getTranslationX(v));
                        mSlidedDistance = 0;
    ...
    private void scrollToRight(final View v) {
        ...
        final MarginLayoutParams params1 = (MarginLayoutParams) v.getLayoutParams();
        logI(TAG, "scrollToRight,ViewHelper.getTranslationX(v)：" + getTranslationX(v));
        ...
        ViewAnimator
                ...
                .translationX(getTranslationX(v), ( rl_slide.getWidth() - params1.leftMargin-slideImageViewWidth))
                ...
                .onStop(new AnimationListener.Stop() {
                    ...
                    public void onStop() {
                        ...
                        logI(TAG, "scrollToRight动画结束,ViewHelper.getTranslationX(v):" + getTranslationX(v));
                        mSlidedDistance = 0;
                        tv_hint.setAlpha(0.0f);
                        mIsUnLocked=true;
